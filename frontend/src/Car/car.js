            ...
            <div className="row">
                <div className="col-md-4 font-weight-bold">Characteristics:
                     ...
                     {this.props.car.characteristics.map(characteristic=>(
                                           <p align="left"><span style={{opacity:0}}>inv</span>-{characteristic.characteristic}</p>
                                           ))}
                                           <p  align="left"><span style={{opacity:0}}>inv</span>Price: {this.props.car.price}$/h</p>

                </div>
                <img src={this.props.car.imgURL} height="265" width="338"  align="middle" hspace="20"/>
            </div>
        );
    }
}
